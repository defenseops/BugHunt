...
export default function Login() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-cyber-bg grid-bg flex items-center justify-center px-4 scanline-overlay">
        {/* ambient glow */}
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xs font-mono text-cyber-muted mt-1 tracking-widest">SECURE LOGIN</p>
          </div>
          ...
          <div className="cyber-card border border-cyber-border rounded-xl p-6 shadow-card">
            ...
            <div className="mt-4 pt-4 border-t border-cyber-border text-center">
              <p className="text-xs font-mono text-cyber-muted">
                No account?{' '}
                <Link to="/register" className="text-cyber-green hover:neon-text transition-all duration-200 cursor-pointer">
                  REGISTER
                </Link>
              </p>
            </div>
